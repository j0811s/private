...
/**
 * 
  <button class="js-lpc-modal_trigger">モーダルボタン</button>

  <div class="lpc-modal js-lpc-modal">
    <div class="lpc-modal_container">
      <button class="lpc-modal_close " type="button"></button>
      <div class="lpc-modal_content">
        <iframe width="100%" height="100%" src="https://www.youtube.com/embed/XXX" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
      </div>
    </div>
  </div>
 */
